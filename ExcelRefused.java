...
public class ExcelRefused extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Richieste Rifiutate");
        ...
        recyclerView.addItemDecoration(dividerItemDecoration);
                    ...
                    requestBeans=(ArrayList<RequestBean>)getIntent().getSerializableExtra("rifiutata");
