...
import it.porting.android_is.utility.LazyInizializedSingleton;
...
public class LoginActivity extends AppCompatActivity {
    ...
    // START FIRESTORE DECLARETION
    private static FirebaseFirestore db = FirebaseFirestore.getInstance();
    //END FIRESTORE DECLARETION
                    ...
                    if (task.isSuccessful()) {
                      ...
                      */
                            ...
                            docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        LazyInizializedSingleton.getInstance().setUser(document.getData());
                                    }
                                }
                            });
                            ...
                            */
                            ...
                            // START CASO 1
                            if(String.valueOf(LazyInizializedSingleton.getInstance().getUser().get("ruolo")).equals("studente")){
                            ...
                            // START CASO 2
                            if(String.valueOf(LazyInizializedSingleton.getInstance().getUser().get("ruolo")).equals("segretario")){
                            ...
                            // START CASO 3
                            if(String.valueOf(LazyInizializedSingleton.getInstance().getUser().get("ruolo")).equals("admin")){
